...
TARGET_NAME=TheSystemComp

all : $(TARGET_NAME)$(EXE_EXT) TheSystemComp.mak

TARGET_MAIN=MainTheSystemComp
...
###############################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) TheSystemComp.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) TheSystemComp.mak
