...
Car.obj : Car.cpp Car.h    STRUCTURE.h Engine.h CarStructure.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Car.obj" "Car.cpp" 



Engine.obj : Engine.cpp Engine.h    STRUCTURE.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Engine.obj" "Engine.cpp" 



CarStructure.obj : CarStructure.cpp CarStructure.h    STRUCTURE.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"CarStructure.obj" "CarStructure.cpp" 



STRUCTURE.obj : STRUCTURE.cpp STRUCTURE.h    Car.h Engine.h CarStructure.h 
	$(CREATE_OBJ_DIR)
...
clean:
	...
	if exist CarStructure.obj erase CarStructure.obj
