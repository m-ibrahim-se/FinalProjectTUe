...
public class ExtractReqDiagramInfoV002 {
	...
	public static void main(String[] args) {
		...
		for (int i0 = 1; i0 <= packages.getCount(); i0++) {
			...
			if (element.getMetaClass().equals("Package")) {
				...
				String dataFileName = packageName.concat("_ReqDiagram.json");
...
//								System.out.println("Target/DependsOn: "+elementDependency.getDependsOn()+"<> DependsOnName: "+ elementDependency.getDependsOn().getName());//Target
							...
							if(elementDependency.getDependsOn().getMetaClass().equals("Requirement")){
								...
								// Do nothing. Because this element may be comment or constraint block and is not in our scope
							}
