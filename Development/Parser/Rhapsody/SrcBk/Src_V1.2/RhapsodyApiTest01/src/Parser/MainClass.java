...
//		pullClassRelations.addActionListener(new classRelationActionListener());
		...
		JButton pullSeqDiagrams = new JButton("Parse Sequence Diagrams");	// FIX THAT IT ONLY PULLS 1 DIAGRAM WHEN AVAILABLE
		...
		writeToFile.addActionListener(new toFileActionListener());
		*/
...
//	}
	...
	static class useCaseDiagramActionListener implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			//ArrayList<IRPUseCaseDiagram> useCaseDiagrams = project.getUseCaseDiagrams(project.getPackages());
